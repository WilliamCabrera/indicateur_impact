...
export const Footer = async () => {
  ...
  return (
    <footer className="w-full p-bq-lg flex flex-col justify-center items-center text-(--color-text-neutral-primary) gap-(--scale-800)">
      ...
      <div className="flex flex-col items-center w-full ">
        <div className="flex gap-(--scale-500) w-full">
          <TextBody4>{t("copyright")}</TextBody4>
          <TextBody4>{t("privacyPolicy")}</TextBody4>
        </div>
        <div className="w-full flex justify-end gap-(--scale-500) ">
